...
### 11. **Пагинация и фильтрация**

**Решение:** Клиентская пагинация с серверной фильтрацией по марке, модели и цене через dedicated features и shared modules в FSD архитектуре.

**Почему:**
- Переиспользование компонентов через shared/pagination и features/cars-filter
